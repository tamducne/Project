<%-- 
    Document   : dashboard
    Created on : Oct 15, 2023, 5:11:16 AM
    Author     : TAMDUC
--%>
...
<jsp:include page="../../common/admin/navigationBar.jsp"></jsp:include>
  ...
  <jsp:include page="../../common/admin/logOutModal.jsp"></jsp:include>
    ...
    <jsp:include page="../../common/admin/addDoctorModal.jsp"></jsp:include>
    <jsp:include page="../../common/admin/editDoctorModal.jsp"></jsp:include>
    
    <jsp:include page="../../common/admin/deleteDoctorModal.jsp"></jsp:include>
